...
$ django-admin startproject belt_project #creates the django project
$ cd belt_project
$ mkdir apps
$ cd apps
$ touch __init__.py  #makes the __init__.py file
$ python ../manage.py startapp belt_app #notice that this is belt_app and not belt_project

$ cd belt_app
$ touch urls.py # make /apps/belt_app/urls.py
$ mkdir templates
$ mkdir static
$ mkdir templates/belt_app
$ touch templates/belt_app/index.html
#also add any html files you want i.e. touch templates/belt_app/index.html
